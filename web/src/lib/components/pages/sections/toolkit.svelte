	...
	<div class="grid gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:gap-16">
		<header class="relative space-y-6 lg:sticky lg:top-28 lg:self-start" use:reveal={{ delay: 0, y: 18 }}>
			...
			<div class="grid max-w-md grid-cols-2 gap-3 text-sm text-slate-700">
				<div class="rounded-2xl border border-[#2A6268]/15 bg-white/45 p-4">
					<QrCode class="mb-5 size-5 text-[#2A6268]" weight="duotone" />
					QR access to low-data digital resources.
				</div>
				<div class="rounded-2xl border border-[#6F231E]/15 bg-white/45 p-4">
					<HeartHandshake class="mb-5 size-5 text-[#6F231E]" weight="duotone" />
			...
			<Button
				href="/toolkit"
				variant="outline"
				class="rounded-full border-[#2A6268]/25 bg-[#FFF9EA]/60 px-5 text-[#1A3C40] hover:bg-[#2A6268]/7"
			>
				Open the kit
		...
		<div class="space-y-6">
			...
			<article
				...
				class="overflow-hidden rounded-[2rem] bg-[#171817] text-[#F6ECD9]"
			>
				<img
